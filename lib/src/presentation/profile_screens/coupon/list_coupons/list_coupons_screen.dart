...
import 'package:projectui/src/presentation/profile_screens/coupon/list_coupons/list_coupons_viewmodel.dart';
...
class ListCouponsState extends State<ListCoupons> with ResponsiveWidget {
  ListCouponsViewModel listCouponsViewModel;

  @override
  Widget build(BuildContext context) {
    return BaseWidget(
        viewModel: ListCouponsViewModel(),
        onViewModelReady: (viewModel) => listCouponsViewModel = viewModel..init(),
        builder: (context, viewModel, child) => Scaffold(
              appBar: AppBar(titleSpacing: 0, title: Text("Coupon của tôi")),
