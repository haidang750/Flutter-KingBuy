...
class OrderDetailState extends State<OrderDetail> {
        ...
        body: Container(
          child: ListView(
            children: [
              ...
              widget.order.isExportInvoice == 1
  ...
  Widget buildOneProduct(String imageSource, String name, Color color,
      int price, int quantity, bool isGift) {
    return Container(
  ...
  Widget buildGifts(List<Gift> gifts) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return buildOneProduct(
            gift.imageSource, gift.name, Colors.blue, gift.price, 1, true);
      },
    );
  }
    ...
    return SingleChildScrollView(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Column(
            children: [
              buildOneProduct(item.imageSource, item.productName, Colors.black,
                  item.price, item.qty, false),
  ...
  Widget buildPaymentInfo(
      int tempPrice, int deliveryCharge, int discount, int total) {
    return Container(
      padding: EdgeInsets.symmetric(vertical: 8, horizontal: 20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(getPaymentType(paymentType),
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400))
          ],
        ));
  }
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("${rewardPoints.toString()} điểm",
                style: TextStyle(
                    fontSize: 18,
