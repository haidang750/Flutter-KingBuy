...
import 'InstallmentDetail_viewmodel.dart';
...
class InstallmentDetailScreenState extends State<InstallmentDetailScreen> with ResponsiveWidget {
  final installmentDetailViewModel = InstallmentDetailViewModel();

  @override
  void initState() {
    super.initState();
    installmentDetailViewModel.detailInstallment(widget.invoiceId);
  }
