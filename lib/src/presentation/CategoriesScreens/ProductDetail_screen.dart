...
import 'package:projectui/src/presentation/CategoriesScreens/ProductDetail_viewmodel.dart';
import 'package:projectui/src/presentation/CategoriesScreens/RatingAndComment_screen.dart';
...
import 'WritingComment_screen.dart';
...
class ProductDetailState extends State<ProductDetail> {
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Image.asset("assets/gift.png", height: 24, width: 24),
              SizedBox(width: 10),
            ...
            itemBuilder: (context, index) => Column(
              children: [
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Image.asset("assets/pin.png", height: 24, width: 24, color: Colors.red.shade700),
                    SizedBox(width: 5),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("KingBuy", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.red.shade700)),
                        SizedBox(height: 5),
                        Text(shopAddress[index].address, style: TextStyle(fontSize: 14)),
                        SizedBox(height: 5),
                        Row(
                          children: [
                            Image.asset("assets/phone.png", height: 14, width: 14, color: Colors.blue),
                            SizedBox(width: 5),
                            GestureDetector(
              ...
              children: [
                ...
                GestureDetector(
                    child: Container(
                        ...
                        alignment: Alignment.center,
                        decoration: BoxDecoration(
                            border: Border.all(width: 1, color: Colors.red.shade700), borderRadius: BorderRadius.all(Radius.circular(6))),
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            SizedBox(width: 10),
                                            comment.isBuy == 1 ? Image.asset("assets/success.png", height: 12, width: 12) : Container(),
                                              ...
                                              if (snapshot.hasData) {
                                                return GestureDetector(
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          color: Colors.red.shade700, borderRadius: BorderRadius.all(Radius.circular(20))),
                                                      alignment: Alignment.center,
  ...
  Widget buildBottomBar() {
    return Container(
      ...
      child: Row(
        children: [
          buildBottomBarItem(MediaQuery.of(context).size.width * 0.15 - 0.5, Colors.white, "assets/zalo.png", 24, false, "Chat Zalo", 11,
              Colors.black, true, handleChatZalo),
          buildVerticalSeperateLine(8, 0.5, Colors.grey),
          buildBottomBarItem(MediaQuery.of(context).size.width * 0.22 - 0.5, Colors.white, "assets/messenger.png", 24, false,
              "Chat Facebook", 11, Colors.black, true, () => AppUtils.handleMessenger(context)),
          buildVerticalSeperateLine(8, 0.5, Colors.grey),
          buildBottomBarItem(MediaQuery.of(context).size.width * 0.28, Colors.white, "assets/shopping-cart.png", 24, true,
              "Thêm vào giỏ hàng", 11, Colors.black, true, handleAddToCart),
          buildBottomBarItem(MediaQuery.of(context).size.width * 0.35, Colors.red.shade700, null, null, false, "Mua ngay", 13, Colors.white,
              false, handlePurchaseButton),
        ],
      ),
    );
  }
  ...
  handlePurchaseButton() async {
    if (await AppUtils.checkLogin()) {
      print("handlePurchaseButton()");
    } else {
      AppUtils.myShowDialog(context, widget.productId, widget.productVideoLink);
    }
  }
